...
public class PetPerdidoImagensResponse {
    private Long id;
    private String mensagem;
    private List<String> caminhosImagens;

    public PetPerdidoImagensResponse() {}
    public PetPerdidoImagensResponse(Long id, String mensagem, List<String> caminhosImagens) {
        this.id = id;
